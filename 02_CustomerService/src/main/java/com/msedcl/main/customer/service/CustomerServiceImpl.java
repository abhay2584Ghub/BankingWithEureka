...
//      return CustomerMapper.toDTO(savedCustomer);
	...
	public List<CustomerResponseDTO> getAllCustomers() {
		...
		List<CustomerResponseDTO> customerResponseDTOsList = new ArrayList<>();
		for(Customer customer:customerList )
			customerResponseDTOsList.add(CustomerMapper.toDTO(customer));
		return customerResponseDTOsList;
	}
